...
// Функция VerticalSplitter() разбивает входной параметр box по ширине
...
// Функция HorizontalSplitter() разбивает входной параметр box по высоте
...
//Функция GetNewBoxes() разбивает входной параметр box по большей стороне, вызывая HorizontalSplitter() или VerticalSplitter()
...
// Функция GetBoxType() добавляет классифицированный ранее box во множество решений, или удаляет его из анализа, или добавляет его к граничной области, или относит его к тем, что подлежат дальнейшему анализу
...
// Функция WriteResults() записывает параметры полученных box-ов (относящихся к рабочему пространству, к граничной области и ко множеству, не являющемуся решением) в выходные файлы для дальнейшей визуализации
